...
void ggml_cuda_op_rwkv_wkv6(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    const float * k_d  = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[0]->data, dst->src[0]);
    const float * v_d  = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[1]->data, dst->src[1]);
    const float * r_d  = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[2]->data, dst->src[2]);
    const float * tf_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[3]->data, dst->src[3]);
    const float * td_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[4]->data, dst->src[4]);
    const float * s_d  = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[5]->data, dst->src[5]);
...
void ggml_cuda_op_rwkv_wkv7(ggml_backend_cuda_context & ctx, ggml_tensor * dst) {
    const float * r_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[0]->data, dst->src[0]);
    const float * w_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[1]->data, dst->src[1]);
    const float * k_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[2]->data, dst->src[2]);
    const float * v_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[3]->data, dst->src[3]);
    const float * a_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[4]->data, dst->src[4]);
    const float * b_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[5]->data, dst->src[5]);
    const float * s_d = (const float *)GGML_CUDA_NAME_TENSOR(dst->src[6]->data, dst->src[6]);
